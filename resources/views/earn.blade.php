        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-xl-6 col-lg-6 col-12">
                <div class="intro-content">
                    <h1>Join the  <strong class="text-primary">{{$web->siteName}}</strong> Referral Programme.
                    </h1>
                    <p>Help us introduce the world to bitcoin, cryptocurrency, and the new financial system to
                        your friends and family, and earn a definite percentage of cryptocurrencies that they buy or
                        sell.
                    </p>
                </div>
            ...
            <div class="col-xl-5 col-lg-6 col-12">
                <img class="img-fluid" src="{{asset('home/images/refer.jpeg')}}" alt="">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row py-lg-5 justify-content-center">
            <div class="col-xl-7">
                <div class="section-title text-center">
                    <h2>How it works</h2>
                    <p>Join our referral program and earn commission by promoting {{$web->siteName}}</p>
                </div>
            </div>
        </div>
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                <div class="getstart-content">
                    ...
                    <h3 class="font-weight-bold">Register an Account</h3>
                    <p>
                        Create an account on {{$web->siteName}} and get your unique referral link and code.
                        </p>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
